...
@section('content')
    ...
    <div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
        <div class="container">
            <h1 class="page-title">Product<span>Create</span></h1>
        </div><!-- End .container -->
    </div><!-- End .page-header -->
        ...
        <div class="cta cta-horizontal cta-horizontal-box bg-image mb-5" style="background-image: url(assets/images/backgrounds/cta/bg-1.jpg); background-position: center right;">
            <div class="row align-items-center">
                <div class="col-lg-4 col-xl-3 offset-xl-1">
                    <h3 class="cta-title">Product Name</h3><!-- End .cta-title -->
                ...
                <div class="col-lg-8 col-xl-7">
                    <form action="{{ route('category.store') }}" method="POST">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" name="product_name" placeholder="Enter your Products Name...." aria-label="Enter Product.." required>
