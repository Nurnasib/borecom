...
@section('content')
    ...
    <main class="main">
        ...
        <div class="col-md-8" style="margin-left: 80%">
            <a href="{{route('products.create')}}" class="btn btn-primary btn-rounded float-end mb-3"> Add Products</a>
        </div>
                ...
                <div class="col-lg-12">
                    <table class="table table-cart table-mobile">
                        ...
                        <tr >
                            ...
                            <th style="font-weight: bold;">Product Category</th>
                        ...
                        <tr class="p-0">
                            ...
                            <td class="text-end row d-flex justify-content-end align-items-center p-0">
                                <!-- Edit Button -->
                                <a href="" class="btn btn-primary btn-rounded " style="min-width: 10px!important;">
